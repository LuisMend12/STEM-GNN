#!/bin/bash
#SBATCH --job-name=stem-pubmed-ood
...
#SBATCH --output=/home/lam23005/STEM-GNN/logs/pubmed_full_ood_%j.out
#SBATCH --error=/home/lam23005/STEM-GNN/logs/pubmed_full_ood_%j.err

source ~/miniconda3/bin/activate STEM-GNN
cd /home/lam23005/STEM-GNN

# All 5 OOD scripts from the paper on Pubmed — MoE + lamda_env=0.1 (no pretrain)

echo "=== 1/5 degree_shift_ood (Pubmed) ==="
