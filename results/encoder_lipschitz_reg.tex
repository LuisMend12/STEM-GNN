...
\paragraph{Results.} \textit{Pending --- the search was still running at
the time of writing. This section will be updated with the best
hyperparameters found and the resulting all-splits test/val/train
accuracy (compared against the untuned baseline row,
\score{75.87}{2.10} test / \score{76.28}{3.34} val /
\score{98.43}{4.25} train) as soon as it completes.}
