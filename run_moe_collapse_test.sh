#!/bin/bash
#SBATCH --job-name=stem-moe-collapse
...
#SBATCH --output=/home/lam23005/STEM-GNN/logs/moe_collapse_test_%j.out
#SBATCH --error=/home/lam23005/STEM-GNN/logs/moe_collapse_test_%j.err

source ~/miniconda3/bin/activate STEM-GNN
cd /home/lam23005/STEM-GNN

echo "=== COLLAPSE TEST: MoE-pretrained encoder, Cora ==="
...
echo "=== COLLAPSE TEST: MoE-pretrained encoder, Pubmed ==="
PYTHONPATH=/home/lam23005/STEM-GNN/STEM-GNN python STEM-GNN/scripts/degree_shift_ood.py \
    --use_params --finetune_dataset pubmed --gpu 0 --debug --repeat 10 \
    --pretrain_run_id moe_pretrain --pretrain_model_epoch 50 \
    --moe --moe_layers all --moe_experts 3 --moe_tau 1.0

echo "=== LAMDA_ENV FIX: MoE-pretrained + entropy reg, Cora ==="
PYTHONPATH=/home/lam23005/STEM-GNN/STEM-GNN python STEM-GNN/scripts/degree_shift_ood.py \
    --use_params --finetune_dataset cora --gpu 0 --debug --repeat 10 \
    --pretrain_run_id moe_pretrain --pretrain_model_epoch 50 \
